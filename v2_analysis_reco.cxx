...
////Created by B.Clark, modified by J. Torres
////Nov 2018
////////////////////////////////////////////////////////////////////////////////
...
int main(int argc, char **argv)
{
  ...
  */
  ...
  double peakTheta_single[2];
  double peakPhi_single[2];

  int runNumOut;
  // prepare for output
  string processedFilename = getProcessedFilename_recoRadius(station_num, argv[6], runNum, radiusBin);
