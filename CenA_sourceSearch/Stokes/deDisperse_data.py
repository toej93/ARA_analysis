...
ROOT.gSystem.Load("/users/PAS0654/osu8354/ARA_cvmfs/build/lib/libRootFftwWrapper.so")
...
for i in range(2000,2500):#loop over events
    if(isTrue):
        break
    ...
    for ch in [0,4,1,5,2,6,3,7]:
        ...
        gr[ch] = ROOT.FFTtools.padWaveToLength(gr[ch],1280)
