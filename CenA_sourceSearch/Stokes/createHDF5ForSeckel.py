...
# 
file_list.append("/users/PAS0654/osu8354/AraSim/outputs/AraOut.default_A2_c1_E610_readIn_noise.txt.runAraSim_input_Seckel.txt.root")
noise=True
...
with h5py.File('./hdf_files/AraSim_outputs_forSeckel_1E18_noise_v2.hdf5', 'w') as f:
    #Event properties
