...
int main(int argc, char **argv)
{
	...
	if(version2){
		...
		*/
		...
		char the_sims[500];
		if(station==2) sprintf(the_sims,"/fs/project/PAS0654/ARA_DATA/A23/sim/ValsForCuts_UsedInA2FinalOpt/A%d/c%d/E224/cutvals_drop_snrbins_0_0_wfrmsvals_-1.3_-1.4_run_*.root",station,config);
