...
data_ara_200 = {
    "pyrex": {
        ...
        "veff": np.array([1.919E-2, 1.197E-1, 8.884E-1, 3.147E+0, 8.740E+0,
                          1.981E+1, 3.518E+1, 8.003E+1, 1.671E+2])
    },
    "arasim": {
...
data_ara_200pa = {
    "pyrex": {
        ...
        "veff": np.array([9.300E-3, 8.955E-2, 5.910E-1, 2.175E+0, 6.272E+0,
                          1.495E+1, 2.872E+1, 5.680E+1, 1.377E+2, 2.294E+2])
    },
    "arasim": {
        "energy": 10**np.array([16.5, 17.0, 17.5, 18.0, 18.5, 19.0, 19.5, 20.0]) / 1e9,
...
data_ara_100 = {
    ...
    "arasim": {
        "energy": 10**np.array([16.5, 17.0, 17.5, 18.0, 18.5, 19.0, 19.5, 20.0]) / 1e9,
        "veff": np.array([8.818E-2, 4.006E-1, 1.381E+0, 3.143E+0,
                          6.155E+0, 1.045E+1, 1.565E+1, 2.248E+1])
    }
}
