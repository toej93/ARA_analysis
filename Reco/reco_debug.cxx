...
////////////////////////////////////////////////////////////////////////////////
////	reco_debug.cxx
////	Reconstruction debugging code. Main goal is to make plots.
////
////	Jorge Torres, Sept 2019.
////////////////////////////////////////////////////////////////////////////////
...
int main(int argc, char **argv)
{
	...
	*/
	...
	for (int i = 0; i < numRadiiScanned; i++){
		...
		theCorrelators[i] = new RayTraceCorrelator(station_num, radius_temp, settings, 1.0, RTTestMode);
	}
	double weight;
	int unixTime;
	int unixTimeUs;
  ...
  //
    ...
    if (calpulserRunMode == 4 && isCalpulser == true && isSoftTrigger == false) { analyzeEvent = true; } // analyze only RF-triggered, calpulser events
