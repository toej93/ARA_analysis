...
int main(int argc, char **argv)
{
	...
	*/
	...
	if (isSimulation == false){
		...
		if(station_num==2){
			runSummaryFilename = "/fs/project/PAS0654/ARA_DATA/A23/sim_SourceSearch/A2/RunSummary/run_summary_station_2_run_20.root";//Not cool to hardcode folder locations, but I don't have time to do it properly :J.T.
		}
