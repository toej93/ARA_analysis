...
for f in $FILES
  do
    (
      ./v2_analysis_filter 1 2 1 /fs/project/PAS0654/ARA_DATA/A23/sim_SourceSearch/A2/RunSummary /fs/project/PAS0654/ARA_DATA/A23/sim_SourceSearch/A2/ProcessedFile "$f" XX
    )&
