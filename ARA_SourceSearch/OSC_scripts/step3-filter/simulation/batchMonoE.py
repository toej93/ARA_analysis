...
for energy in range(560,610,5):
    ...
    "--job-name=filter_A{0}_E{1} --output=./logs/filter_A{0}_E{1}.out "
    "--export=,STATION={0},ENERGY={1},OUTDIR={2},SIMDIR={3} submit_filter_sim_monoE.sh").format(station,energy,outDir,simDir)
